...
(name_c, time_list, day_list) = ("ECE 212",('12:00', '13:00'), ["Monday", "Wednesday", "Friday"])

def button(root):
    menu = Button(root, text = 'Menu', relief = "raised", command = MenuWin)
...
def save_contents(Days, course_name, Times):
    ...
    print("End:", time_end)
    print(day_list)
    return(name_c, time_list, day_list)
